 // FyraTal-RättaTill.jsx
// TabbaFyraTal-MedTabbstopp-55mm
...
if (app.selection.length > 0) {
        ...
        if (textFrame.constructor.name === "TextFrame" && textFrame.contents) {
            ...
            if (matches.length > 0) {
                for (var j = 0; j < matches.length; j++) {
                    ...
                    // Sätt textrutans bredd till exakt 55 mm
    ...
    if (updatedCount > 0) {
        ...
        alert("Inga textrutor med exakt fyra tal hittades i de markerade objekten.");
    }
} else {

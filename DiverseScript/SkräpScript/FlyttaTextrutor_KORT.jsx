// JusteraTextrutor-MedHöjdOchPlacering-RensaText.jsx
// --------------------------------------------------------------------

// Justera dessa värden för att ändra standardhöjd och avstånd:
var newHeight = 4; // Textrutans höjd i mm
var distanceWithinLayer = 0.12; // Avståndet mellan textrutor i samma lager i mm
...
app.doScript(function () {
    ...
    for (var layer in framesByLayer) {
        ...
        // Justera höjd, rensa text och placering av textrutorna
        for (var j = 0; j < textFrames.length; j++) {
            var bounds = textFrames[j].geometricBounds;

            // Rensa eventuella mellanslag i textens början och slut
            if (textFrames[j].contents) {
                textFrames[j].contents = textFrames[j].contents.replace(/^\s+|\s+$/g, "");
            }
